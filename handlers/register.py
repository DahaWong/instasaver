...
from handlers.inline_query import all_unread_handler, get_folders_handler, select_folder_handler


handlers = [conversation.login_handler,
            conversation.quit_handler,
            conversation.delete_link_handler,
            about_handler, test_handler, get_folders_handler, all_unread_handler, select_folder_handler]
